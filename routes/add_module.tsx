      ...
      <div class={tw`bg-gray`}>
        ...
        >
          <section class={tw`inset-y-0 px-10 flex`}>
            <div class={tw`flex flex-col space-y-4 my-auto px-4 md:px-16 lg:px-24 xl:px-32`}>
              <div class={tw`my-auto py-10`}>
                ...
                <ModuleStep title="Select a module name">
                  ...
                  <div>
                    <label htmlFor="modulename" class={tw`font-semibold sr-only`}>
                      Module Name
                    </label>
                    <input
                      id="modulename"
...
function ModuleStep(
  ...
  return (
    <div class={tw`mt-12`}>
      <header>
        <h2 class={tw`text-2xl leading-7 font-semibold text-gray-900`}>{title}</h2>
      </header>
      <div class={tw`mt-4`}>
        {children}
      </div>
