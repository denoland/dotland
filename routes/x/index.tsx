                  ...
                  <dd class={tw`mt-2`}>
                    ...
                    <span class={tw`block w-full rounded-md shadow-sm mt-4`}>
                      <a
                        href="/add_module"
                        class={tw
                          `w-full flex justify-center py-2 px-4 border border-gray-300 font-medium rounded-md text-gray-700 bg-gray-100 hover:text-gray-500 hover:bg-gray-50 focus:outline-none focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition duration-150 ease-in-out`}
                      >
                        Publish a module
                      </a>
                    </span>
