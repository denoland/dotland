...
/** @jsx h */
import { h, Head, tw } from "../deps.ts";
import { Header } from "../components/Header.tsx";
import { Footer } from "../components/Footer.tsx";

export default function NotFoundPage() {
  return (
    <div class={tw`width-full min-h-screen overflow-x-hidden relative flex justify-between flex-col flex-wrap`}>
      <Head>
      ...
      <div class={tw`flex-bottom`}>
        <div class={tw`mt-auto w-full pointer-events-none h-[200px] relative overflow-hidden`}>
          <img
