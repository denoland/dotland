...
function ModuleView({
  ...
  function SidePanel() {
    return (
      <div class="col-span-1 row-start-1 md:row-start-auto flex flex-col sm:flex-row md:flex-col gap-4">
        <div class="max-w-sm w-full shadow-sm rounded-lg border border-gray-200 overflow-hidden">
          <div class="bg-gray-50 p-4">
            ...
            {versionMeta === undefined
              ? (
                <>
                  <div class="w-4/5 sm:w-full bg-gray-100 h-3 my-2">
                  </div>
                  ...
                  <div class="mt-2 flex items-center py-0.5">
                    ...
                    <div class="w-1/6 sm:w-1/5 bg-gray-100 h-4">
                    </div>
                  </div>
                </>
              )
...
function Breadcrumbs({
  ...
  return (
    <p class="text-gray-500">
      <a href="/" class="link">deno.land</a> / {!isStd && (
        <>
