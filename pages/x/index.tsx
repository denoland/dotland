  ...
  return (
    <>
      ...
      <div className="bg-gray">
        <Header subtitle="مۆدیوڵەکان" widerContent={true} />
          ...
          >
            ...
            <dd className="mt-2">
              <p className="text-base leading-6 text-gray-500">
                ...
                خزمەتگوزارییەکی بڵاوکردنەوەی گشتییە بۆ مۆدیوڵی دێنۆ. وەشانی
                مۆدیوڵەکان لە گیتهەبەوە دەهێنێت و لە شوێنێک دایان دەنێت کە
                ناوەکەی ئاسان بێت بۆ بیرهاتنەوە
              </p>
            </dd>
