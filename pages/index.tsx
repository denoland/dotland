...
export default function Home() {
  const complexExampleProgram =
    `import { serve } from "https://deno.land/std@${versions.std[0]}/http/server.ts";
    ...
    <div>
      <>
        ...
        <div className="bg-white">
          ...
          <div className="max-w-screen-sm mx-auto px-4 sm:px-6 md:px-8 mt-20">
            <a className="hover:underline" href="#installation">
          ...
          <div className="max-w-screen-sm mx-auto px-4 sm:px-6 md:px-8">
            <p className="my-4 text-gray-700">
              ...
              setup guides in{" "}
              <a className="link" href="/manual">the manual</a>.
            </p>
          </div>
          <div className="max-w-screen-sm mx-auto px-4 sm:px-6 md:px-8 mt-20">
            <a className="hover:underline" href="#runtime-documentation">
            ...
            <p className="my-4 text-gray-700">
              Deno comes with{" "}
              <a className="link"  href="/manual">a manual</a>{" "}
          ...
          <div className="max-w-screen-sm mx-auto px-4 sm:px-6 md:px-8 mt-20">
              <a className="hover:underline" href="#standard-modules">
            ...
            <p className="my-4 text-gray-700">
              ...
              <a className="link" href="/std">deno.land/std</a>{" "}
              and are distributed via URLs like all other ES modules that are
              compatible with Deno.
            </p>
          </div>
          <div className="max-w-screen-sm mx-auto px-4 sm:px-6 md:px-8 mt-20">
            <a className="hover:underline" href="#third-party-modules">
            ...
            <p className="my-4 text-gray-700">
              ...
              <a className="link" href="/x">deno.land/x</a>.
            </p>
          </div>
          <div className="mt-20">
            <Footer simple />
