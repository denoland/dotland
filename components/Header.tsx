      ...
      >
        ...
        <div className="hidden lg:flex md:ml-10 items-end">
          <Link href="/#installation">
            <a className="font-medium text-gray-500 hover:text-gray-900 transition duration-300 ease-in-out">
              Install
            </a>
          </Link>
          <Link href="/manual">
            <a className="ml-10 font-medium text-gray-500 hover:text-gray-900 transition duration-300 ease-in-out">
              Manual
            </a>
          </Link>
          <a
            href="https://deno.com/blog"
            className="ml-10 font-medium text-gray-500 hover:text-gray-900 transition duration-300 ease-in-out"
          >
            Blog
          </a>
          <a
          ...
          <a
            ...
            className="ml-10 text-gray-500 hover:text-gray-900 transition duration-300 ease-in-out"
            style={{ lineHeight: 0 }}
          >
          ...
          <div className="rounded-lg shadow-md">
            <div className="rounded-lg bg-white shadow-xs overflow-hidden">
              ...
              <div className="px-2 pt-4 pb-3">
                <Link href="/#installation">
                  <a className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-300 ease-in-out">
                    Install
                  </a>
                </Link>
                <Link href="/manual">
                ...
                <a
                  href="https://doc.deno.land/builtin/stable"
                  className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-300 ease-in-out"
                >
                  Runtime API
                </a>
                <Link href="/std">
