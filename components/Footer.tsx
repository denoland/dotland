      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center">
          <div className="px-5 py-2">
            <Link href="/[...rest]" as="/manual">
              <a className="text-base leading-6 text-gray-500 hover:text-gray-900 ease-in-out duration-300">
                Manual
              </a>
            </Link>
          </div>
          <div className="px-5 py-2">
            <a
              ...
              className="text-base leading-6 text-gray-500 hover:text-gray-900 ease-in-out duration-300"
            >
              Runtime API
            </a>
          </div>
        ...
        <div className="mt-9 flex justify-center">
          <a
            ...
            className="text-gray-400 hover:text-gray-500 ease-in-out duration-300"
          >
          ...
          <a
            ...
            className="ml-6 text-gray-400 hover:text-gray-500 ease-in-out duration-300"
          >
