              ...
              if (versions === null) {
                return (
                  <ErrorMessage
                    ...
                    body="No se ha podido encontrar el módulo pedido."
                  />
                );
              } else if (
                ...
                return (
                  <ErrorMessage
                    ...
                    body={`Este nombre de módulo se ha reservado para un repositorio, pero aún no se han cargado versiones. Se eliminarán los módulos que no carguen una versión dentro de los 30 días posteriores al registro. ${
                      versions.isLegacy
                        ? "Si es el propietario de este módulo, vuelva a agregar el repositorio de GitHub con deno.land/x (siguiendo las instrucciones en https://deno.land/x#add) y publique una nueva versión."
                        : ""
                    }`}
                  />
                );
                    ...
                    {(() => {
                      if (
                        ...
                        return (
                          <ErrorMessage
                            title="404 - Módulo no econtrado"
                            body="Esta versión no existe para este módulo."
                          />
                        );
                      } else if (
                        versionMeta &&
                        ...
                        return (
                          <ErrorMessage
                            ...
                            body="No se pudo encontrar este archivo o directorio."
                          />
                        );
                          ...
                          <>
                            ...
                            <div className="mt-2 flex items-center py-0.5">
                              <svg
                                ...
                                viewBox="0 0 20 20"
                              >
                                <title>Estrellas en GitHub</title>
