                ...
                return (
                  <ErrorMessage
                    ...
                    body={`ئەم مۆدیوڵە ناوەکەی گیراوە، بەڵام هیچ وەشانێکی بڵاو نەکراوەتەوە. ئەو مۆدیوڵانەی تا 30 ڕۆژ دوای تۆمار بوونیان هیچ وەشانێکیان بڵاو ناکرێتەوە، خۆکارانە لادەبرێن. ${
                      versions.isLegacy
                        ? "ئەگەر تۆ خاوەنی ئەم مۆدیوڵەیت، تکایە سەرچاوەکەی دیسانەوە زۆر بکە لە ڕێی deno.land/x (بە ڕەچاوکردنی هەنگاوەکان لە https://deno.land/x#add) و وەشانێکی نوێ بڵاوبکەرەوە."
                        : ""
                    }`}
                  />
                );
