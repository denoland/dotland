...
Deno.test("get introduction file old repo", () => {
  assertEquals(
    ...
    "https://deno-registry2-prod-storagebucket-b3a31d16.s3.amazonaws.com/deno/versions/v1.12.0/raw/docs/introduction.md",
  );
});
...
Deno.test("get introduction file new repo", () => {
  assertEquals(
    ...
    "https://deno-registry2-prod-storagebucket-b3a31d16.s3.amazonaws.com/manual/versions/v1.12.1/raw/introduction.md",
  );
});
