...
`,
    ...
    [
      ...
      [
        { types: ["plain"], content: "" },
        { types: ["keyword", "module"], content: "import" },
        { types: ["plain"], content: " " },
        { types: ["imports", "punctuation"], content: "{" },
        { types: ["imports"], content: " serve " },
        { types: ["imports", "punctuation"], content: "}" },
        { types: ["plain"], content: " " },
        { types: ["keyword", "module"], content: "from" },
        { types: ["plain"], content: " " },
        {
          types: ["string"],
      ...
      [
        { types: ["plain"], content: "" },
        { types: ["console", "class-name"], content: "console" },
        { types: ["punctuation"], content: "." },
        { types: ["method", "function", "property-access"], content: "log" },
        { types: ["punctuation"], content: "(" },
      ...
      [
        ...
        { types: ["punctuation"], content: "{" },
        { types: ["plain"], content: " " },
        { types: ["literal-property", "property"], content: "port" },
