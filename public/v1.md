...
A hello-world Deno HTTP server makes about 25k requests per second with a max
latency of 1.3 milliseconds. A comparable Node program makes 34k requests per
