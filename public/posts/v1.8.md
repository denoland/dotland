...
Deno, with GPU acceleration, out of the box. We expect this to be achieved in
the coming months.
...
For more examples visit this repository: https://github.com/crowlKats/webgpu-examples
